...
const PreEngineeringSolutionsPage = () => {
    return (
        <div className="flex-1 bg-[#eaf2fb] text-slate-900 font-sans selection:bg-[#4E9CE4] selection:text-white flex flex-col relative mt-0">
            ...
            <div className="relative w-full pt-32 pb-24 md:pt-44 md:pb-32 px-6 md:px-12 mx-auto min-h-[60vh] flex flex-col justify-center">
                <div
                    ...
                    style={{ backgroundImage: "url('/i2.jpg')" }}
                >
                ...
                <div className="max-w-[1500px] mx-auto w-full z-10">
                    <FadeIn className="max-w-[800px] w-full mt-4 md:mt-8">
                        ...
                        <p className="text-[17px] md:text-[22px] font-medium leading-relaxed text-blue-50/90 mb-10 max-w-[650px] text-left drop-shadow-sm border-l-4 border-[#4E9CE4] pl-6 transition-colors duration-500">
                            Detailed pre-engineering surveys to assess site conditions and inform precise project design.
                        </p>
...
export default PreEngineeringSolutionsPage;
